...
const nftData = [
  ...
  },
  {
    ...
    level: "Level 4",
    showLevelIcon: true,
    levelColor: "var( --Green--100)",
    levelTextColor: "var(--white-100)",
    progress: "100%",
    progressColor: "var( --Green--100)",
    name: "Maple Sapling #5678",
    yield: "CO2 yield of 1.2 Tonnes",
    stakeText: "Not Applicable",
    stakeColor: "var(--btn-pink)",
    date: "July 01, 2024"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    showLevelIcon: false,
    levelColor: "#ffffff",
    levelTextColor: "var( --Green--100)",
    progress: "100%",
    progressColor: "var( --Green--100)",
    name: "Amazon Plot #007",
    yield: "CO2 yield of 1.2 Tonnes",
    stakeText: "Active Staking",
    stakeColor: "var(--btn-lightGreen)",
    date: "July 01, 2024"
  },
  {
    id: 5,
